...
| 5 | AI chỉ tự khai chất lượng nguồn *(sơ cấp / thứ cấp)* **sau khi bị hỏi thẳng** — Norman là nguồn thứ cấp | [`a4-ai-audit-report.md`](a4-ai-audit-report.md) — phụ lục, prompt P3 |
...
| 7 | Script audit do AI viết có **khoá trùng trong object literal**, làm 11 ô bị ghi đè âm thầm và để trống. Chỉ phát hiện khi **đếm lại bằng `grep -c`**, không phát hiện được bằng đọc | [`a4-ai-audit-report.md`](a4-ai-audit-report.md) dòng #6 |
| 8 | Ba kết luận sai phải sửa tay: `F-01` báo "thiếu nhãn" trong khi nhãn **có** nhưng không gắn `for`/`id`; `F-04` báo "không phát hiện được lỗi" vì màu khai bằng `lab()`; `G-01` chấm Failed cho dialog trong khi đúng phải là `N/A` | [`a4-ai-audit-report.md`](a4-ai-audit-report.md) dòng #6 |
